...
<form action="#" method="get" class="grid grid2-auto-fr" oninput="kikan()" style="width: 15.0em">

<label for="power">基礎攻撃力</label>
<input type="number" id="power" value="1000" min="1" max="99999" step="1" />

<label for="lv">武装Lv</label>
<input type="number" id="lv" value="1" min="1" max="999999" step="1" />

<label for="status" title="主砲攻撃力、副砲攻撃力、弾幕攻撃力のLv">兵種Lv</label>
<input type="number" id="status" value="0" min="0" max="9999" step="1" />

<label for="jyuugeki">重撃チップ</label>
<input type="number" id="jyuugeki" value="0" min="0" max="1000" step="1" />

<label for="kansyu" title="砲艦、SF、巡洋艦の艦種熟練度Lv">艦種Lv</label>
<input type="number" id="kansyu" value="9999" min="0" max="9999" step="1" />

<label for="ace">一騎当千Lv</label>
<input type="number" id="ace" value="0" min="0" max="9999" step="1" />

<label for="over">銀河の英雄Lv</label>
<input type="number" id="over" value="9999" min="0" max="9999" step="1" />
...
<input type="number" id="cut" value="0" min="0" max="100" step="0.1" />
...
<form action="#" method="get" class="grid grid2-auto-fr" oninput="ryoukan()" style="width: 15.0em">

<label for="power2">基礎攻撃力</label>
<input type="number" id="power2" value="1000" min="1" max="99999" step="1" />

<label for="lv2">武装Lv</label>
<input type="number" id="lv2" value="0" min="1" max="999999" step="1" />

<label for="status2">攻撃司令Lv</label>
<input type="number" id="status2" value="9999" min="0" max="9999" step="1" />

<label for="kansyu2">潜宙艦Lv</label>
<input type="number" id="kansyu2" value="0" min="0" max="9999" step="1" />

<label for="over2">銀河の英雄Lv</label>
<input type="number" id="over2" value="9999" min="0" max="9999" step="1" />
...
<input type="number" id="cut2" value="0" min="0" max="100" step="0.1" />
