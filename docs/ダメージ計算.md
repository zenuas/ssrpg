...
<input type="number" id="power" value="1000" min="1" max="99999" step="1" required />
...
<input type="number" id="cut" value="0" min="0" max="100" step="0.1" required />
...
<input type="number" id="power2" value="1000" min="1" max="99999" step="1" required />

<label for="lv2">武装Lv</label>
<input type="number" id="lv2" value="0" min="1" max="999999" step="1" required />

<label for="status2">攻撃司令Lv</label>
<input type="number" id="status2" value="9999" min="0" max="9999" step="1" required />

<label for="kansyu2">潜宙艦Lv</label>
<input type="number" id="kansyu2" value="0" min="0" max="9999" step="1" required />

<label for="over2">銀河の英雄Lv</label>
<input type="number" id="over2" value="9999" min="0" max="9999" step="1" required />
...
<input type="number" id="cut2" value="0" min="0" max="100" step="0.1" required />
